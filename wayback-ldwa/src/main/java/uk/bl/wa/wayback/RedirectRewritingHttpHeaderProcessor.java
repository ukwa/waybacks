...
public class RedirectRewritingHttpHeaderProcessor 
	...
	public void filter(Map<String, String> output, String key, String value,
		...
		// Replace 'attachment' with 'inline' (Trac #2224). 
		if( keyUp.equals( HTTP_CONTENT_DISP_HEADER_UP ) && value.indexOf( "attachment" ) != -1 ) {
			output.put(  key, value.replace( "attachment", "inline" ) );
		}
	}
}