...
<head>
	...
	<link rel="DC.rights copyright" href="http://www.bl.uk/copyrightstatement.html"/>
	<meta name="DC.creator" content="David Golding"/>
	<meta name="DC.publisher" content="The British Library"/>
	<meta name="DCTERMS.created" scheme="DCTERMS.W3CDTF" content="2012-10-23"/>
...
#header {
	...
	/*margin: 0px 0px 0px 0px; uncomment this line if newsletter signup visible and comment out the previous line */
	height: 100px;
}
#logo {
	float:left;
...
#mainnav {
	clear:both;
	height:22px;
	background-image:url(/images/generic/breadcrumbbottomborder.jpg);
...
#rcolpanel {
	background: url(/images/generic/storiesmiddle.jpg);
	background-repeat: no-repeat;
