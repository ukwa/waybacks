...
window.open = function() {
  ...
  base.open = function(sUrl, strWindowName, features, replace ){
      console.log("OPEN "+strWindowName+": "+sUrl); //manipulate sUrl here return 
      alert("OPEN "+strWindowName+": "+sUrl);
	  base.openBase(sUrl, strWindowName, features, replace);
  }
  return base;
}
