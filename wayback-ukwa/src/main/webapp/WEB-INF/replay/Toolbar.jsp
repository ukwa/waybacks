...
<div id="wm-ipp-inside" style="position:fixed;padding:0!important;margin:0!important;width:97%;min-width:780px;border:5px solid #000;border-top:none;background-image:url(<%= staticPrefix %>images/toolbar/wm_tb_bk_trns.png);text-align:center;-moz-box-shadow:1px 1px 3px #333;-webkit-box-shadow:1px 1px 3px #333;box-shadow:1px 1px 3px #333;font-size:11px!important;font-family:'Lucida Grande','Arial',sans-serif!important;" dir="ltr">
   <table style="border-collapse:collapse;margin:0;padding:0;width:100%;"><tbody><tr>
   <td style="padding:10px;vertical-align:top;width:149px;">
   <a href="<%= queryPrefix %>" title="UK Web Archive Wayback Home Page" style="background-color:transparent;border:none;float:left;margin-right:4px;"><img src="<%= staticPrefix %>images/toolbar/wayback-toolbar-logo.png" alt="UK Web Archive" border="0"/></a>
   </td>
   <td style="padding:10px;vertical-align:top;width:8%;">
   <div style="font-size: 9px !important;color:#333;text-align:center;line-height:1.0em;"><%= fmt.format("ToolBar.playbackWarning") %></div>
   </td>
