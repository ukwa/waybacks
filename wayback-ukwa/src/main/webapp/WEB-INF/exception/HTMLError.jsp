...
<jsp:include page="/WEB-INF/template/UI-header.jsp" flush="true" />
        ...
        <div id="positionHome">
            <section class="bt-content" style="margin: 0 1em;">
            <div id="error">
...
%>
			...
			<ul>
			  ...
			  <li><a href="https://www.webarchive.org.uk/mementos/search/<%= fmt.escapeHtml(requestUrl) %>">Seeing if other web archives hold copies of this URL</a></li>
			</ul>
