...
%></td>
                                ...
                                <tr>
                                        ...
                                        <span id="bl_disclaimer" class="message">External links, forms and search boxes may not function within archived websites.</span></td>
                                </tr>
                        </table>
                </td>
...
<a style="display:inline; background: url(); padding: 0 0 0 0;"  href="http://www.bl.uk" border="0"><img style="display: inline;" alt='The British Library' src='/img/Providedby.gif'  border="0"></a>
        ...
        <td colspan="2" align="center">
                <span id="bl_disclaimer" class="message">External links, forms and search boxes may not function within these archived websites.</span>
        </td>
        </tr>
        -->
</table>
