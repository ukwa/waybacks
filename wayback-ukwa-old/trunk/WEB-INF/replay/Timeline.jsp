...
<style type="text/css">
        table.wayback, table.wayback tr td {
                margin: 0;
                padding: 0;
                border: 0;
...
<div id="wm-ipp" style="position:relative;z-index:99999;border:1px solid;color:#0099CC;background-color:white;font-size:10px;font-family:Verdana, Arial, Helvetica, sans-serif;padding:5px" >
<table cellspacing="0" border="0" cellpadding="0"  width="100%" class="wayback">
	<tr>
		<td><a style="color:#0099CC;text-decoration:none;font-size:10px;font-family:Verdana, Arial, Helvetica, sans-serif;" href="javascript:void( document.getElementById( 'wm-ipp' ).style.display = 'none' )">[hide]</a></td>
	</tr>
	<tr>
		<td width="1" nowrap></td>
		<td><a style="display:inline; background: url(); padding: 0 0 0 0;" wmSpecial="1" href="http://www.ukwebarchive.org.uk/ukwa/" ><img style="display: inline;" alt="UK Web Archive" src="http://serv02.bl.ulcc.ac.uk/img/UKwebarchive.png" border=0></a>
			<!-- Viewing -->
			<table cellspacing="0" border="0" cellpadding="0" width="100%" class="wayback">
				<tr>
					<td>
...
%></td>
      ...
      %></a>
-->
<a style="display:inline; background: url(); padding: 0 0 0 0;"  href="http://www.bl.uk" border="0"><img style="display: inline;"  alt='The British Library' src='http://www.ukwebarchive.org.uk/img/Providedby.gif'  border="0"></a>
		</td>
		<td>
